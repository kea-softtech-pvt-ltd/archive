<?php
	...
	$pagLink .= "<li class='$disable' style='$style'><a href='fav?page=".($page-1)."'>&laquo;</a></li>"; 
    ...
    $pagLink .= "<li class=".$current."><a href='fav?page=".$i."'>".$i." ".$icon."</a></li>";
};  
	if($page==$total_pages){   
	$disable1 = 'disabled';
	...
	$pagLink .= "<li class='$disable1' style='$style1' ><a href='fav?page=".($page+1)."' class='button'>&raquo;</a></li>";
