<?php
	...
	$pagLink .= "<li class='$disable' style='$style'><a href='search_list?page=".($page-1)."'>&laquo;</a></li>"; 
	...
	for ($i=1; $i<=$total_pages; $i++) { 
		...
		$pagLink .= "<li class=".$current."><a href='search_list?page=".$i."'>".$i." ".$icon."</a></li>";
	};  
	if($page==$total_pages){   
		$disable1 = 'disabled';
	...
	$pagLink .= "<li class='$disable1' style='$style1' ><a href='search_list?page=".($page+1)."' class='button'>&raquo;</a></li>";
