			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<!--<input type="text" name="builder_name" id="builder_name" class="form-control" placeholder="Builder name" />-->
						<select class="form-control"  name="builder_name" id="builder_name" <?php if (($_SESSION['role'] == 3)) {?> style="pointer-events:none" <?php }?>>
...
?>
									<option   <?php if (($_SESSION['role'] == 3)) {?> <?php if (($_SESSION['id'] == $_smarty_tpl->tpl_vars['v']->value['id'])) {?> selected <?php }?> <?php }?> value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
					...
					<div class="form-group">
						...
						<select  data-placeholder="Select Amenities"  class="form-control chosen-select" multiple name="amenitieName[]" id="amenitieName" multiple>
							<option value="">Select Amenities</option>
								<?php
$_from = $_smarty_tpl->tpl_vars['amenitiesListArray']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<select data-placeholder="Select Neighbourhoods" name="neibhourhood[]" id="neibhourhood" multiple class="chosen-select">
   								<?php
$_from = $_smarty_tpl->tpl_vars['neighbourhoodListArray']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
...
/ajaxproperties",
        ...
        success: function(response){
           ...
           // setTimeout(function(){ window.location.href='<?php echo $_smarty_tpl->tpl_vars['adminroot']->value;?>
/properties'; }, 4000);
		},
        error: function (jqXHR, textStatus, errorThrown)
        {
...
// Select units
    ...
    function dynamic_field(number) {
		...
		var unitsType = <?php echo json_encode($_smarty_tpl->tpl_vars['unitsTypeListArray']->value);?>
;
		var proType = <?php echo json_encode($_smarty_tpl->tpl_vars['proTypeListArray']->value);?>
;
		var unitop = '';
		var proop = '';
