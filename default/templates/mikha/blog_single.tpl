        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1 col-sm-12">
            ...
            <ol class="breadcrumb">
              <li><a href="#">Home</a></li>
              <li><a href="#">blog</a></li>
              <li class="active">Sak sruputan njuk nulis meneh</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="blog-container">
              <div class="blog-image" style="background-image: url(img/img16.jpg);">
                <div class="blog-author">
                  ...
                  <span><a href="#">Kuriman</a> on June 30, 2014</span><br><br>
                  <span>/ In <a href="#">Property</a>, <a href="#">Life style</a></span>
                </div>
              </div>
              ...
              <div class="row">
                <form>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <input type="text" class="form-control input-lg" name="author" placeholder="Your name : ">
                    </div>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control input-lg" rows="6" placeholder="Your comment : "></textarea>
                    </div>
